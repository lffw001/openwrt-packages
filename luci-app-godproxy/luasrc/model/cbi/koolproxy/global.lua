...
o = Map("koolproxy", translate("GodProxy 滤广告 "), translate("GodProxy是基于KoolProxyR Plus重新整理的能识别adblock规则的免费开源软件,追求体验更快、更清洁的网络，屏蔽烦人的广告！<br /><font color=\"red\">屏蔽内置视频规则更新，内置可运行版本。其余规则可正常更新且正常运行。<br /></font>"))
